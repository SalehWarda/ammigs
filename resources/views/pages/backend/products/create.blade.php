                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="app_store_link" class="form-control" value="{{old('app_store_link')}}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="google_play_link" class="form-control" value="{{old('google_play_link')}}">
