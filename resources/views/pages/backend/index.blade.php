                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="year-tab" data-toggle="tab" href="#year"
                                               role="tab" aria-controls="year" aria-selected="false">Year </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane fade active show" id="months" role="tabpanel"
                                    ...
                                    <div class="row mb-30">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">We also know those epic stories, those
                                                modern.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">Remind yourself you have nowhere to go
                                                except. </p>
                                            <span class="mb-0">by - <b
                                ...
                                <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                    <div class="row mb-30">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">Understanding the price and having the
                                    ...
                                    <div class="row mb-30">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">Success to you and then pull it out when
                                                you are.</p>
                                    ...
                                    <div class="row mb-30">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">Motivators for your personality and your
                                                personal goals. </p>
                                            <span class="mb-0">by - <b
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <p class="sm-mb-5 d-block">The first thing to remember about success
                                                is that. </p>
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-20">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="mt-0 mb-0">Car dealer <span class="float-right text-danger"> 8,561</span>
                                        </h6>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="mt-0 mb-0">Webster <span class="float-right text-warning"> 6,213</span>
                                        </h6>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="mt-0 mb-0">The corps <span class="float-right text-success"> 2,926</span>
                                        </h6>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success save-event">Create event
                                    </button>
